            ...
            <div className="w-full h-2/3 flex bg-blue-100 border">
                <div className='w-2/4 px-4 py-4'>
                    <div className='mx-5 my-20 cursor-default'>
                        ...
                        <div className='flex mt-5'>
                            <button className='bg-blue-700 border-none rounded-md text-white px-4 py-4 text-lg mr-2'>
                                Start Learning
                            </button>
                ...
                <div className='w-2/4 flex justify-center items-center'>
                    <div className='w-full h-full rounded flex justify-center items-center'>
                        <div className='bg-white rounded-s w-3/4 h-3/4 flex items-center justify-center flex-col'>
                            ...
                            <div className='flex flex-col'>
                                <h4 className='font-semibold text-xl text-gray-800'>Choose Your Language</h4>
